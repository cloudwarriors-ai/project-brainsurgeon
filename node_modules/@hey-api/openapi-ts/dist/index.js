import {createRequire}from'module';import {b,a,c,u,K,r,i,k,l,j,h,L,o,p as p$1,F,E,n,A,g,e,d,m,y,v,x,q,B as B$1,C,D,f,z}from'./chunk-Z7FL5BGA.js';export{G as clientDefaultConfig,H as clientDefaultMeta,I as clientPluginHandler,w as compiler,s as defaultPaginationKeywords,J as defaultPlugins,t as definePluginConfig,v as tsc}from'./chunk-Z7FL5BGA.js';import b$1 from'ansi-colors';import gr from'color-support';import P from'node:path';import R from'node:fs';import Et from'typescript';import p from'handlebars';createRequire(import.meta.url);
var Be=b((oo,Ie)=>{Ie.exports=De;De.sync=wt;var Se=a("fs");function kt(e,n){var o=n.pathExt!==void 0?n.pathExt:process.env.PATHEXT;if(!o||(o=o.split(";"),o.indexOf("")!==-1))return  true;for(var r=0;r<o.length;r++){var t=o[r].toLowerCase();if(t&&e.substr(-t.length).toLowerCase()===t)return  true}return  false}function He(e,n,o){return !e.isSymbolicLink()&&!e.isFile()?false:kt(n,o)}function De(e,n,o){Se.stat(e,function(r,t){o(r,r?false:He(t,e,n));});}function wt(e,n){return He(Se.statSync(e),e,n)}});var _e=b((so,Fe)=>{Fe.exports=$e;$e.sync=Ot;var je=a("fs");function $e(e,n,o){je.stat(e,function(r,t){o(r,r?false:Ne(t,n));});}function Ot(e,n){return Ne(je.statSync(e),n)}function Ne(e,n){return e.isFile()&&St(e,n)}function St(e,n){var o=e.mode,r=e.uid,t=e.gid,s=n.uid!==void 0?n.uid:process.getuid&&process.getuid(),a=n.gid!==void 0?n.gid:process.getgid&&process.getgid(),i=parseInt("100",8),u=parseInt("010",8),l=parseInt("001",8),c=i|u,f=o&l||o&u&&t===a||o&i&&r===s||o&c&&s===0;return f}});var We=b((ao,Le)=>{a("fs");var M;process.platform==="win32"||global.TESTING_WINDOWS?M=Be():M=_e();Le.exports=K;K.sync=Ht;function K(e,n,o){if(typeof n=="function"&&(o=n,n={}),!o){if(typeof Promise!="function")throw new TypeError("callback not provided");return new Promise(function(r,t){K(e,n||{},function(s,a){s?t(s):r(a);});})}M(e,n||{},function(r,t){r&&(r.code==="EACCES"||n&&n.ignoreErrors)&&(r=null,t=false),o(r,t);});}function Ht(e,n){try{return M.sync(e,n||{})}catch(o){if(n&&n.ignoreErrors||o.code==="EACCES")return  false;throw o}}});var Xe=b((lo,Ke)=>{var H=process.platform==="win32"||process.env.OSTYPE==="cygwin"||process.env.OSTYPE==="msys",Me=a("path"),Dt=H?";":":",Ue=We(),Ve=e=>Object.assign(new Error(`not found: ${e}`),{code:"ENOENT"}),Ge=(e,n)=>{let o=n.colon||Dt,r=e.match(/\//)||H&&e.match(/\\/)?[""]:[...H?[process.cwd()]:[],...(n.path||process.env.PATH||"").split(o)],t=H?n.pathExt||process.env.PATHEXT||".EXE;.CMD;.BAT;.COM":"",s=H?t.split(o):[""];return H&&e.indexOf(".")!==-1&&s[0]!==""&&s.unshift(""),{pathEnv:r,pathExt:s,pathExtExe:t}},ze=(e,n,o)=>{typeof n=="function"&&(o=n,n={}),n||(n={});let{pathEnv:r,pathExt:t,pathExtExe:s}=Ge(e,n),a=[],i=l=>new Promise((c,f)=>{if(l===r.length)return n.all&&a.length?c(a):f(Ve(e));let m=r[l],d=/^".*"$/.test(m)?m.slice(1,-1):m,y=Me.join(d,e),q=!d&&/^\.[\\\/]/.test(e)?e.slice(0,2)+y:y;c(u(q,l,0));}),u=(l,c,f)=>new Promise((m,d)=>{if(f===t.length)return m(i(c+1));let y=t[f];Ue(l+y,{pathExt:s},(q,k)=>{if(!q&&k)if(n.all)a.push(l+y);else return m(l+y);return m(u(l,c,f+1))});});return o?i(0).then(l=>o(null,l),o):i(0)},It=(e,n)=>{n=n||{};let{pathEnv:o,pathExt:r,pathExtExe:t}=Ge(e,n),s=[];for(let a=0;a<o.length;a++){let i=o[a],u=/^".*"$/.test(i)?i.slice(1,-1):i,l=Me.join(u,e),c=!u&&/^\.[\\\/]/.test(e)?e.slice(0,2)+l:l;for(let f=0;f<r.length;f++){let m=c+r[f];try{if(Ue.sync(m,{pathExt:t}))if(n.all)s.push(m);else return m}catch{}}}if(n.all&&s.length)return s;if(n.nothrow)return null;throw Ve(e)};Ke.exports=ze;ze.sync=It;});var Je=b((uo,X)=>{var Qe=(e={})=>{let n=e.env||process.env;return (e.platform||process.platform)!=="win32"?"PATH":Object.keys(n).reverse().find(r=>r.toUpperCase()==="PATH")||"Path"};X.exports=Qe;X.exports.default=Qe;});var nn=b((po,en)=>{var Ye=a("path"),Bt=Xe(),jt=Je();function Ze(e,n){let o=e.options.env||process.env,r=process.cwd(),t=e.options.cwd!=null,s=t&&process.chdir!==void 0&&!process.chdir.disabled;if(s)try{process.chdir(e.options.cwd);}catch{}let a;try{a=Bt.sync(e.command,{path:o[jt({env:o})],pathExt:n?Ye.delimiter:void 0});}catch{}finally{s&&process.chdir(r);}return a&&(a=Ye.resolve(t?e.options.cwd:"",a)),a}function $t(e){return Ze(e)||Ze(e,true)}en.exports=$t;});var tn=b((co,J)=>{var Q=/([()\][%!^"`<>&|;, *?])/g;function Nt(e){return e=e.replace(Q,"^$1"),e}function Ft(e,n){return e=`${e}`,e=e.replace(/(?=(\\+?)?)\1"/g,'$1$1\\"'),e=e.replace(/(?=(\\+?)?)\1$/,"$1$1"),e=`"${e}"`,e=e.replace(Q,"^$1"),n&&(e=e.replace(Q,"^$1")),e}J.exports.command=Nt;J.exports.argument=Ft;});var on=b((fo,rn)=>{rn.exports=/^#!(.*)/;});var an=b((mo,sn)=>{var _t=on();sn.exports=(e="")=>{let n=e.match(_t);if(!n)return null;let[o,r]=n[0].replace(/#! ?/,"").split(" "),t=o.split("/").pop();return t==="env"?r:r?`${t} ${r}`:t};});var un=b((go,ln)=>{var Y=a("fs"),Lt=an();function Wt(e){let o=Buffer.alloc(150),r;try{r=Y.openSync(e,"r"),Y.readSync(r,o,0,150,0),Y.closeSync(r);}catch{}return Lt(o.toString())}ln.exports=Wt;});var mn=b((yo,fn)=>{var Mt=a("path"),pn=nn(),cn=tn(),Ut=un(),Vt=process.platform==="win32",Gt=/\.(?:com|exe)$/i,zt=/node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;function Kt(e){e.file=pn(e);let n=e.file&&Ut(e.file);return n?(e.args.unshift(e.file),e.command=n,pn(e)):e.file}function Xt(e){if(!Vt)return e;let n=Kt(e),o=!Gt.test(n);if(e.options.forceShell||o){let r=zt.test(n);e.command=Mt.normalize(e.command),e.command=cn.command(e.command),e.args=e.args.map(s=>cn.argument(s,r));let t=[e.command].concat(e.args).join(" ");e.args=["/d","/s","/c",`"${t}"`],e.command=process.env.comspec||"cmd.exe",e.options.windowsVerbatimArguments=true;}return e}function Qt(e,n,o){n&&!Array.isArray(n)&&(o=n,n=null),n=n?n.slice(0):[],o=Object.assign({},o);let r={command:e,args:n,options:o,file:void 0,original:{command:e,args:n}};return o.shell?r:Xt(r)}fn.exports=Qt;});var yn=b((ho,gn)=>{var Z=process.platform==="win32";function ee(e,n){return Object.assign(new Error(`${n} ${e.command} ENOENT`),{code:"ENOENT",errno:"ENOENT",syscall:`${n} ${e.command}`,path:e.command,spawnargs:e.args})}function Jt(e,n){if(!Z)return;let o=e.emit;e.emit=function(r,t){if(r==="exit"){let s=dn(t,n);if(s)return o.call(e,"error",s)}return o.apply(e,arguments)};}function dn(e,n){return Z&&e===1&&!n.file?ee(n.original,"spawn"):null}function Yt(e,n){return Z&&e===1&&!n.file?ee(n.original,"spawnSync"):null}gn.exports={hookChildProcess:Jt,verifyENOENT:dn,verifyENOENTSync:Yt,notFoundError:ee};});var Rn=b((vo,D)=>{var hn=a("child_process"),ne=mn(),te=yn();function vn(e,n,o){let r=ne(e,n,o),t=hn.spawn(r.command,r.args,r.options);return te.hookChildProcess(t,r),t}function Zt(e,n,o){let r=ne(e,n,o),t=hn.spawnSync(r.command,r.args,r.options);return t.error=t.error||te.verifyENOENTSync(t.status,r),t}D.exports=vn;D.exports.spawn=vn;D.exports.sync=Zt;D.exports._parse=ne;D.exports._enoent=te;});var qe=()=>{if(typeof Bun<"u"){let[e]=Bun.version.split(".").map(Number);if(e<1)throw new h(`Unsupported Bun version ${Bun.version}. Please use Bun 1.0.0 or newer.`)}else if(typeof process<"u"&&process.versions?.node){let[e]=process.versions.node.split(".").map(Number);if(e<18)throw new h(`Unsupported Node version ${process.versions.node}. Please use Node 18 or newer.`)}};var W=e=>{switch(e){case "legacy/angular":return "AngularHttpRequest";case "legacy/axios":return "AxiosHttpRequest";case "legacy/fetch":return "FetchHttpRequest";case "legacy/node":return "NodeHttpRequest";case "legacy/xhr":return "XHRHttpRequest";default:return ""}};var Ae=async(e,n$1,o,r)=>{let t=n(),s=m(t),a=r.client({$config:t,...o,httpRequest:W(s.name),models:D(o.models),services:D(o.services)});p$1(t)&&(f(n$1),R.writeFileSync(P.resolve(n$1,`${p$1(t)}.ts`),a));};var Te=async(e,n$1,o)=>{let r=n();if(r.exportCore){let t=m(r),s={httpRequest:W(t.name),server:r.base!==void 0?r.base:n$1.server,version:n$1.version};if(R.rmSync(P.resolve(e),{force:true,recursive:true}),R.mkdirSync(P.resolve(e),{recursive:true}),await R.writeFileSync(P.resolve(e,"OpenAPI.ts"),o.core.settings({$config:r,...s})),await R.writeFileSync(P.resolve(e,"ApiError.ts"),o.core.apiError({$config:r,...s})),await R.writeFileSync(P.resolve(e,"ApiRequestOptions.ts"),o.core.apiRequestOptions({$config:r,...s})),await R.writeFileSync(P.resolve(e,"ApiResult.ts"),o.core.apiResult({$config:r,...s})),t.name!=="legacy/angular"&&await R.writeFileSync(P.resolve(e,"CancelablePromise.ts"),o.core.cancelablePromise({$config:r,...s})),await R.writeFileSync(P.resolve(e,"request.ts"),o.core.request({$config:r,...s})),p$1(r)&&(await R.writeFileSync(P.resolve(e,"BaseHttpRequest.ts"),o.core.baseHttpRequest({$config:r,...s})),await R.writeFileSync(P.resolve(e,`${s.httpRequest}.ts`),o.core.httpRequest({$config:r,...s}))),r.request){let a=P.resolve(process.cwd(),r.request);if(!await R.existsSync(a))throw new Error(`Custom request file "${a}" does not exists`);await R.copyFileSync(a,P.resolve(e,"request.ts"));}}};var Ee=({files:e})=>{let n$1=n();e.index=new x({dir:n$1.output.path,id:"index",name:"index.ts"}),p$1(n$1)&&e.index.add(v.exportNamedDeclaration({exports:p$1(n$1),module:`./${p$1(n$1)}`})),n$1.exportCore&&(e.index.add(v.exportNamedDeclaration({exports:"ApiError",module:"./core/ApiError"})),n$1.plugins["@hey-api/sdk"]?.config.response==="response"&&e.index.add(v.exportNamedDeclaration({exports:{asType:true,name:"ApiResult"},module:"./core/ApiResult"})),p$1(n$1)&&e.index.add(v.exportNamedDeclaration({exports:"BaseHttpRequest",module:"./core/BaseHttpRequest"})),m(n$1).name!=="legacy/angular"&&e.index.add(v.exportNamedDeclaration({exports:["CancelablePromise","CancelError"],module:"./core/CancelablePromise"})),e.index.add(v.exportNamedDeclaration({exports:["OpenAPI",{asType:true,name:"OpenAPIConfig"}],module:"./core/OpenAPI"}))),Object.keys(e).sort().forEach(o=>{let r=e[o];o==="index"||r.isEmpty()||r.exportFromIndex&&e.index.add(v.exportAllDeclaration({module:`./${r.nameWithoutExtension()}`}));});};var ke=async({client:e$1,openApi:n$1,templates:o$1})=>{let r=n(),t=n$1;if(e$1){if(r.plugins["@hey-api/sdk"]?.config.include&&r.plugins["@hey-api/sdk"].config.asClass){let l=new RegExp(r.plugins["@hey-api/sdk"].config.include);e$1.services=e$1.services.filter(c=>l.test(c.name));}if(r.plugins["@hey-api/typescript"]?.config.include){let l=new RegExp(r.plugins["@hey-api/typescript"].config.include);e$1.models=e$1.models.filter(c=>l.test(c.name));}}let s=P.resolve(r.output.path);r.output.clean&&g(s);let a=e(d(r.output.tsConfigPath)),i=m(r);!o(r)&&"bundle"in i.config&&i.config.bundle&&y({legacy:true,outputPath:s,plugin:i,tsConfig:a}),await Ae(t,s,e$1,o$1),await Te(P.resolve(r.output.path,"core"),e$1,o$1);let u={};for(let l of r.pluginOrder){let c=r.plugins[l],f=(c.output??"").split("/"),m=P.resolve(r.output.path,...f.slice(0,f.length-1));u[c.name]=new x({dir:m,id:`legacy-unused-${c.name}`,name:`${f[f.length-1]}.ts`}),c.handlerLegacy?.({client:e$1,files:u,openApi:t,plugin:c});}Ee({files:u}),Object.entries(u).forEach(([l,c])=>{r.dryRun||(l==="index"?c.write(`
`,a):c.write(`

`,a));});};var we=async({context:e$1})=>{let n=P.resolve(e$1.config.output.path);e$1.config.output.clean&&g(n);let o=e(d(e$1.config.output.tsConfigPath)),r=o?.options.moduleResolution===Et.ModuleResolutionKind.NodeNext,t=m(e$1.config);"bundle"in t.config&&t.config.bundle&&y({outputPath:n,plugin:t,tsConfig:o});for(let s of e$1.registerPlugins())await s.run();if(!e$1.config.dryRun){let s=e$1.createFile({id:"_index",path:"index"});for(let a of Object.values(e$1.files))if(a.nameWithoutExtension()!==s.nameWithoutExtension()){if(!a.isEmpty()&&a.exportFromIndex&&e$1.config.output.indexFile){let u=s.relativePathToFile({context:e$1,id:a.id});r&&(u.startsWith("./")||u.startsWith("../"))&&(u==="./client"?u="./client/index.js":u=`${u}.js`),s.add(v.exportAllDeclaration({module:u}));}a.write(`

`,o);}e$1.config.output.indexFile&&s.write(`
`,o);}};var Oe=({patchOptions:e,spec:n})=>{if(!e)return;let o=n;if("swagger"in o){if(e.version&&o.swagger&&(o.swagger=typeof e.version=="string"?e.version:e.version(o.swagger)),e.meta&&o.info&&e.meta(o.info),e.schemas&&o.definitions)for(let r in e.schemas){let t=o.definitions[r];if(!t||typeof t!="object")continue;let s=e.schemas[r];s(t);}if(e.operations&&o.paths)for(let r in e.operations){let[t,s]=r.split(" ");if(!t||!s)continue;let a=o.paths[s];if(!a)continue;let i=a[t.toLocaleLowerCase()]||a[t.toLocaleUpperCase()];if(!i||typeof i!="object")continue;let u=e.operations[r];u(i);}return}if(e.version&&o.openapi&&(o.openapi=typeof e.version=="string"?e.version:e.version(o.openapi)),e.meta&&o.info&&e.meta(o.info),o.components){if(e.schemas&&o.components.schemas)for(let r in e.schemas){let t=o.components.schemas[r];if(!t||typeof t!="object")continue;let s=e.schemas[r];s(t);}if(e.parameters&&o.components.parameters)for(let r in e.parameters){let t=o.components.parameters[r];if(!t||typeof t!="object")continue;let s=e.parameters[r];s(t);}if(e.requestBodies&&o.components.requestBodies)for(let r in e.requestBodies){let t=o.components.requestBodies[r];if(!t||typeof t!="object")continue;let s=e.requestBodies[r];s(t);}if(e.responses&&o.components.responses)for(let r in e.responses){let t=o.components.responses[r];if(!t||typeof t!="object")continue;let s=e.responses[r];s(t);}}if(e.operations&&o.paths)for(let r in e.operations){let[t,s]=r.split(" ");if(!t||!s)continue;let a=o.paths[s];if(!a)continue;let i=a[t.toLocaleLowerCase()]||a[t.toLocaleUpperCase()];if(!i||typeof i!="object")continue;let u=e.operations[r];u(i);}};var re=c(Rn(),1),er={biome:{args:e=>["format","--write",e],command:"biome",name:"Biome (Format)"},prettier:{args:e=>["--ignore-unknown",e,"--write","--ignore-path","./.prettierignore"],command:"prettier",name:"Prettier"}},nr={biome:{args:e=>["lint","--apply",e],command:"biome",name:"Biome (Lint)"},eslint:{args:e=>[e,"--fix"],command:"eslint",name:"ESLint"},oxlint:{args:e=>["--fix",e],command:"oxlint",name:"oxlint"}},Pn=({config:e})=>{if(e.output.format){let n=er[e.output.format];console.log(`\u2728 Running ${n.name}`),(0, re.sync)(n.command,n.args(e.output.path));}if(e.output.lint){let n=nr[e.output.lint];console.log(`\u2728 Running ${n.name}`),(0, re.sync)(n.command,n.args(e.output.path));}};function xn(e,n){return {...e,config:n,models:e.models.map(o=>tr(o)),services:rr(e.operations).map(or),types:{}}}var tr=e=>({...e,$refs:e.$refs.filter((n,o,r)=>B$1(n,o,r)),enum:e.enum.filter((n,o,r)=>r.findIndex(t=>t.value===n.value)===o),enums:e.enums.filter((n,o,r)=>r.findIndex(t=>t.name===n.name)===o),imports:e.imports.filter((n,o,r)=>B$1(n,o,r)&&n!==e.name).sort(C)}),rr=e=>{let n$1=n(),o=new Map;return e.forEach(r=>{(r.tags?.length&&(n$1.plugins["@hey-api/sdk"]?.config.asClass||p$1(n$1))?r.tags.filter(B$1):["Default"]).forEach(s=>{let a={...r,service:ar(s)},i=o.get(a.service)||ir(a);i.$refs=[...i.$refs,...a.$refs],i.imports=[...i.imports,...a.imports],i.operations=[...i.operations,a],o.set(a.service,i);});}),Array.from(o.values())},or=e=>{let n={...e};return n.operations=sr(n),n.operations.forEach(o=>{n.imports.push(...o.imports);}),n.imports=n.imports.filter(B$1).sort(C),n},sr=e=>{let n=new Map;return e.operations.map(o=>{let r={...o};r.imports.push(...r.parameters.flatMap(i=>i.imports));let t=r.responses.filter(i=>i.responseTypes.includes("success"));r.imports.push(...t.flatMap(i=>i.imports));let s=r.name,a=n.get(s)||0;return a>0&&(r.name=`${s}${a}`),n.set(s,a+1),r})},ir=e=>({$refs:[],imports:[],name:e.service,operations:[]}),ar=e=>u({case:"PascalCase",value:z(e)});var oe=e=>e.startsWith(q),ur=e=>{let n={path:""};if(e.path&&(typeof e.path!="string"||!oe(e.path)))return n.path=e.path,n;let[o,r]=e.path.split("?"),s=(r||"").split("&").map(x=>x.split("=")),a=o||"";a.endsWith("/")&&(a=a.slice(0,a.length-1));let[,i]=a.split("://"),[u,l,c]=(i||"").split("/");n.organization=l||e.organization,n.project=c||e.project;let f=[],m="api_key";n.api_key=s.find(([x])=>x===m)?.[1]||e.api_key||process.env.HEY_API_TOKEN,n.api_key&&f.push(`${m}=${n.api_key}`);let d="branch";n.branch=s.find(([x])=>x===d)?.[1]||e.branch,n.branch&&f.push(`${d}=${n.branch}`);let y="commit_sha";n.commit_sha=s.find(([x])=>x===y)?.[1]||e.commit_sha,n.commit_sha&&f.push(`${y}=${n.commit_sha}`);let q="tags";n.tags=s.find(([x])=>x===q)?.[1]?.split(",")||e.tags,n.tags?.length&&f.push(`${q}=${n.tags.join(",")}`);let k="version";if(n.version=s.find(([x])=>x===k)?.[1]||e.version,n.version&&f.push(`${k}=${n.version}`),!n.organization)throw new Error("missing organization - from which Hey API Platform organization do you want to generate your output?");if(!n.project)throw new Error("missing project - from which Hey API Platform project do you want to generate your output?");let T=f.join("&"),O=u||"get.heyapi.dev",le=O.startsWith("localhost"),ue=[le?"http":"https",O].join("://"),pe=le?[ue,"v1","get",n.organization,n.project].join("/"):[ue,n.organization,n.project].join("/");return n.path=T?`${pe}?${T}`:pe,n},Cn=e=>{let n=b$1.cyan("Generating from");if(typeof e.path=="string"){let o=oe(e.path)?`${e.organization??""}/${e.project??""}`:e.path;console.log(`\u23F3 ${n} ${o}`),oe(e.path)&&(e.branch&&console.log(`${b$1.gray("branch:")} ${b$1.green(e.branch)}`),e.commit_sha&&console.log(`${b$1.gray("commit:")} ${b$1.green(e.commit_sha)}`),e.tags?.length&&console.log(`${b$1.gray("tags:")} ${b$1.green(e.tags.join(", "))}`),e.version&&console.log(`${b$1.gray("version:")} ${b$1.green(e.version)}`));}else console.log(`\u23F3 ${n} raw OpenAPI specification`);},se=async({config:e,dependencies:n,logger:o$1,templates:r,watch:t})=>{let s=ur(e.input),{timeout:a}=e.input.watch,i=t||{headers:new Headers};e.logs.level!=="silent"&&!t&&Cn(s);let u=o$1.timeEvent("spec"),{data:l,error:c,response:f}=await L({fetchOptions:e.input.fetch,inputPath:s.path,timeout:a,watch:i});if(u.timeEnd(),c&&!t)throw new Error(`Request failed with status ${f.status}: ${f.statusText}`);let m,d;if(l){e.logs.level!=="silent"&&t&&(console.clear(),Cn(s));let y=o$1.timeEvent("input.patch");Oe({patchOptions:e.parser.patch,spec:l}),y.timeEnd();let q=o$1.timeEvent("parser");if(e.experimentalParser&&!o(e)&&!p$1(e)&&(d=F({config:e,dependencies:n,logger:o$1,spec:l})),!d){let O=E({openApi:l});m=xn(O,e);}q.timeEnd();let k=o$1.timeEvent("generator");d?await we({context:d}):m&&await ke({client:m,openApi:l,templates:r}),k.timeEnd();let T=o$1.timeEvent("postprocess");if(!e.dryRun&&(Pn({config:e}),e.logs.level!=="silent")){let O=process.env.INIT_CWD?`./${P.relative(process.env.INIT_CWD,e.output.path)}`:e.output.path;console.log(`${b$1.green("\u{1F680} Done!")} Your output is in ${b$1.cyanBright(O)}`);}T.timeEnd();}return e.input.watch.enabled&&typeof s.path=="string"&&setTimeout(()=>{se({config:e,dependencies:n,logger:o$1,templates:r,watch:i});},e.input.watch.interval),d||m};var bn={1:function(e,n,o,r,t){return `import { NgModule} from '@angular/core';
...
`+((s=i(o,"equals").call(a,i(i(i(i(t,"root"),"$config"),"client"),"name"),"legacy/angular",{name:"equals",hash:{},fn:e.program(8,t,0),inverse:e.program(11,t,0),data:t,loc:{start:{line:23,column:0},end:{line:87,column:11}}}))!=null?s:"")},useData:true};var qn={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){return `export const getHeaders = <T>(config: OpenAPIConfig, options: ApiRequestOptions<T>): Observable<HttpHeaders> => {
	...
	return undefined;
};`},useData:true};var En={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){return `export const getResponseHeader = <T>(response: HttpResponse<T>, responseHeader?: string): string | undefined => {
	if (responseHeader) {
	...
	return undefined;
};`},useData:true};var kn={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){var s,a=e.lookupProperty||function(i,u){if(Object.prototype.hasOwnProperty.call(i,u))return i[u]};return `import { HttpClient, HttpHeaders } from '@angular/common/http';
...
};`},usePartial:true,useData:true};var wn={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){return `export const sendRequest = <T>(
...
export class CancelablePromise<T> implements Promise<T> {
...
};`},useData:true};var Wn={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){return `export const getRequestBody = (options: ApiRequestOptions): unknown => {
	if (options.body !== undefined) {
		if (options.mediaType?.includes('application/json') || options.mediaType?.includes('+json')) {
			return JSON.stringify(options.body);
		} else if (isString(options.body) || isBlob(options.body) || isFormData(options.body)) {
	...
	return undefined;
};`},useData:true};var Mn={compiler:[8,">= 4.3.0"],main:function(e,n,o,r,t){return `export const getResponseBody = async (response: Response): Promise<unknown> => {
	if (response.status !== 204) {
		try {
...
};`},useData:true};var pr=()=>{p.registerHelper("camelCase",function(e){return u({case:"camelCase",value:e})}),p.registerHelper("equals",function(e,n,o){return e===n?o.fn(this):o.inverse(this)}),p.registerHelper("ifServicesResponse",function(e,n$1){return n().plugins["@hey-api/sdk"]?.config.response===e?n$1.fn(this):n$1.inverse(this)}),p.registerHelper("ifdef",function(...e){let n=e.pop();return e.every(o=>!o)?n.inverse(this):n.fn(this)}),p.registerHelper("notEquals",function(e,n,o){return e!==n?o.fn(this):o.inverse(this)}),p.registerHelper("transformServiceName",function(e){return A({config:n(),name:e})});},mt=()=>{pr();let e={client:p.template(bn),core:{apiError:p.template(On),apiRequestOptions:p.template(Sn),apiResult:p.template(Hn),baseHttpRequest:p.template(Fn),cancelablePromise:p.template(_n),httpRequest:p.template(ot),request:p.template(it),settings:p.template(st)}};return p.registerPartial("functions/base64",p.template(zn)),p.registerPartial("functions/catchErrorCodes",p.template(Kn)),p.registerPartial("functions/getFormData",p.template(Xn)),p.registerPartial("functions/getQueryString",p.template(Qn)),p.registerPartial("functions/getUrl",p.template(Jn)),p.registerPartial("functions/isBlob",p.template(Yn)),p.registerPartial("functions/isFormData",p.template(Zn)),p.registerPartial("functions/isString",p.template(et)),p.registerPartial("functions/isStringWithValue",p.template(nt)),p.registerPartial("functions/isSuccess",p.template(tt)),p.registerPartial("functions/resolve",p.template(rt)),p.registerPartial("fetch/getHeaders",p.template(Ln)),p.registerPartial("fetch/getRequestBody",p.template(Wn)),p.registerPartial("fetch/getResponseBody",p.template(Mn)),p.registerPartial("fetch/getResponseHeader",p.template(Un)),p.registerPartial("fetch/request",p.template(Vn)),p.registerPartial("fetch/sendRequest",p.template(Gn)),p.registerPartial("xhr/getHeaders",p.template(at)),p.registerPartial("xhr/getRequestBody",p.template(lt)),p.registerPartial("xhr/getResponseBody",p.template(ut)),p.registerPartial("xhr/getResponseHeader",p.template(pt)),p.registerPartial("xhr/request",p.template(ct)),p.registerPartial("xhr/sendRequest",p.template(ft)),p.registerPartial("axios/getHeaders",p.template(Dn)),p.registerPartial("axios/getRequestBody",p.template(In)),p.registerPartial("axios/getResponseBody",p.template(Bn)),p.registerPartial("axios/getResponseHeader",p.template(jn)),p.registerPartial("axios/request",p.template($n)),p.registerPartial("axios/sendRequest",p.template(Nn)),p.registerPartial("angular/getHeaders",p.template(qn)),p.registerPartial("angular/getRequestBody",p.template(An)),p.registerPartial("angular/getResponseBody",p.template(Tn)),p.registerPartial("angular/getResponseHeader",p.template(En)),p.registerPartial("angular/request",p.template(kn)),p.registerPartial("angular/sendRequest",p.template(wn)),e};var cr=0,dt=e=>`${e}-${cr++}`,ie=e=>`${e}-end`,gt=e=>`${e}-length`,ae=e=>`${e}-start`,fr=(e,n)=>{if(e>200)return {color:b$1.red,type:"duration"};if(n>30)return {color:b$1.red,type:"percentage"};if(e>50)return {color:b$1.yellow,type:"duration"};if(n>10)return {color:b$1.yellow,type:"percentage"}},B=class{events=[];end(n){let o,r=this.events;for(let t of n.position)o=r[t],o?.events&&(r=o.events);o&&!o.end&&(o.end=performance.mark(ie(o.id)));}report(n=true){let o=this.events[0];if(!o)return;let r=this.events[this.events.length-1],t="root",s=dt(t),a=performance.measure(gt(s),ae(o.id),ie(r.id));return n&&this.reportEvent({end:r.end,events:this.events,id:s,indent:0,measure:a,name:t,start:o.start}),a}reportEvent({indent:n,...o}){let r=n?b$1.gray:b$1.cyan,t=o.events.length-1;o.events.forEach((s,a)=>{let i=performance.measure(gt(s.id),ae(s.id),ie(s.id)),u=Math.ceil(i.duration*100)/100,l=Math.ceil(i.duration/o.measure.duration*100*100)/100,c=n?fr(u,l):void 0,f=`${u.toFixed(2).padStart(8)}ms`;c?.type==="duration"&&(f=c.color(f));let m=a===t?"\u2514\u2500 ":"\u251C\u2500 ",d=n?"\u2502  ".repeat(n-1)+m:"",y=38-d.length,q=n?"\u21B3 ":"",T=`${n?" ".repeat(n-1)+q:""}${l.toFixed(2)}%`;c?.type==="percentage"&&(T=c.color(T)),console.log(b$1.gray(d)+r(`${s.name.padEnd(y)} ${f} (${T})`)),this.reportEvent({...s,indent:n+1,measure:i});});}start(n){return performance.mark(ae(n))}storeEvent({result:n,...o}){let r=o.events.length-1,t=o.events[r];if(t&&!t.end){n.position=[...n.position,r],this.storeEvent({...o,events:t.events,result:n});return}let s=o.events.push({...o,events:[]});n.position=[...n.position,s-1];}timeEvent(n){let o=dt(n),r=this.start(o),t={events:this.events,id:o,name:n,start:r},s={position:[]};return this.storeEvent({...t,result:s}),{mark:r,timeEnd:()=>this.end(s)}}};var mr={stringCase:u};b$1.enabled=gr().hasBasic;var ji=async(e,n=new B)=>{let o=typeof e=="function"?await e():e,r$1=[];try{qe();let t=n.timeEvent("createClient"),s=n.timeEvent("config"),a=await K(o);for(let m of a.results)if(r$1.push(m.config),m.errors.length)throw m.errors[0];s.timeEnd();let i=n.timeEvent("handlebars"),u=mt();i.timeEnd();let c=(await Promise.all(r$1.map(m=>se({config:m,dependencies:a.dependencies,logger:n,templates:u})))).filter(m=>!!m);t.timeEnd();let f=r$1[0];return n.report(f&&f.logs.level==="debug"),c}catch(t){let s=r$1[0],a=s?s.dryRun:o?.dryRun,i$1=s?s.interactive:o?.interactive,u=s?.logs??r(o),l$1;throw u.level!=="silent"&&u.file&&!a&&(l$1=i(t,u.path??"")),u.level!=="silent"&&(k({error:t,logPath:l$1}),await l({error:t,isInteractive:i$1})&&await j(t)),t}},$i=async e=>typeof e=="function"?await e():e;export{B as Logger,ji as createClient,$i as defineConfig,mr as utils};//# sourceMappingURL=index.js.map
